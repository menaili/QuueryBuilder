...
<body>
   ...
   <div class="container login ">
        ...
        <form action="{{route('Articles.update',$articles->id)}}" enctype="multipart/form-data" method="post">
            ...
            <div >
                <input type="text" name="name" value="{{$articles->title}}" id="name" required>
            </div>
            ...
            <div >
                <input type="text" name="model" value="{{$articles->model_number}}" id="model" required>
            </div>
            ...
            <div >
                <input type="text" name="link" value="{{$articles->lien}}" id="link" required>
            </div>
            ...
            <div >
                <input  type="number" name="price" id="price" value="{{$articles->price}}" required>
            </div>
            ...
            <div >
                <textarea name="description" id="description"  rows="10" required>{{$articles->texte}}</textarea>
            </div>
            ...
            <div >
                <textarea name="advantage" id="advantage"  rows="10" required>{{$articles->description}}</textarea>
            </div>
